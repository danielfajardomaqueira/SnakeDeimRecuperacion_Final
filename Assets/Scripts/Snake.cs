...
public class Snake : MonoBehaviour
{
    ...
    # region VARIABLES
    public Vector2Int gridPosition; // Posición 2D de la cabeza
    public Vector2Int startGridPosition;
    public Direction gridMoveDirection; // Dirección de la cabeza
    ...
    public int snakeBodySize; // Cantidad de partes del cuerpo (sin cabeza)
    public List<SnakeMovePosition> snakeMovePositionsList; // Posiciones y direcciones de cada parte (por orden)
    ...
    public float GetAngleFromVector(Vector2Int direction)
    {
